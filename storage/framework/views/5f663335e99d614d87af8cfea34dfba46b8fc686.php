            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e(url('/product/add')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">Agregar</a>
...
<?php /**PATH H:\xampp\htdocs\prueba-izzi\resources\views/welcome.blade.php ENDPATH**/ ?>